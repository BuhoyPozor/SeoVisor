...
chrome.extension.onMessage.addListener(function(request)  { 
    ...
    console.log("-- function - chrome.extension.onMessage.addListener");
...
//	console.log("----------- href with l-ext"+$( 'a[class="l-ext"]' ).length);
	...
	// current tab	
	chrome.extension.sendRequest({message: 'basic-tab', type: 'first-tab'}, function(response) {});
}

function trackGa(pathWithSlash){	
	chrome.extension.sendRequest({message: pathWithSlash, type: 'clicked'}, function(response) {});
}
